...
export function wasm_plugin_exported__hello(): i32 {
 ...
 export function wasm_plugin_exported__echo(): i32 {
    ...
    return String.UTF8.encodeUnsafe(changetype<usize>(input), input.length, changetype<usize>(MESSAGE_BUFFER));
 }
 ...
 export function wasm_plugin_exported__favorite_numbers(): i32 {
     ...
     return String.UTF8.encodeUnsafe(changetype<usize>(response), response.length, changetype<usize>(MESSAGE_BUFFER));
 }
